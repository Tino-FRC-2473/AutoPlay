...
/**
 * Over database that stores a snapshot of the joysticks and sensor values in a
 * thread safe way This is constantly updated by multiple querying threads. To
 * use this class, you can access the values by using the getValue and getButton
 * methods. This class follows the <a href = "">singleton design pattern</a>
 * 
...
public class Database {
	...
	public static final double LEFT_ENC_CONSTANT = 1;// .01944349; // scales
														// encoders
														// to inches
	public static final double RIGHT_ENC_CONSTANT = 1;// .00827586;

	/**
	 * an enum that describes all the sensors that this database is
	 * tracking.<br>
	 * This includes the joysticks.<br>
	 * To add a new sensor, add it here as an enum element and update the
	 * appropriate calling method. ex Sensor Thread, OI
	 * 
	 * @author thatSteveFan
	 * 
	 */
	...
	/**
	 * This is the enum that defines the different buttons that will be
	 * avaliable for use. To add a new button, add it as the enum element and
	 * update the appropriate thread, ex. OI
	 * 
	 * @author RehanDurrani
	 *
	 */
	 ...
	 */
	private Database() {
		HashMap<Value, ThreadSafeHolder> tempMap = (new HashMap<>());// creates
																		// the
																		// map
	 ...
	 *            the value you are querying
	 * @param the
	 *            value responding to the value enum
	 */
	 ...
	 *            the name of the button
	 * @param newValue
	 *            the state of button, pressed or not
	 */
	...
	/**
	 * Logs values directly to the dashboard Use this method to print sensor and
	 * joystick values
	 */
	public void log() {
...
/**
 * A class capable of storing a single double value in a thread-safe value. It
 * uses the java <a href = "">ReentrantReadWriteLock</a> to make a FIFO acess
 * 
 * @author thatSteveFan, Will Fang
 *
 */
